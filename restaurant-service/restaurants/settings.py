...
SECRET_KEY = "django-insecure-h$a8t)zf^$n#0b$isuz57#zbabqc0l(*v(sa%ef73yd-q7!apb"
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("DATABASE_NAME", "food_restaurants"),
...
STATIC_URL = "static/"
MEDIA_URL = "/restaurant-service-media/"
